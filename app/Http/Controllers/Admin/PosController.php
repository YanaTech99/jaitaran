        ...
        if ($orderData) {
            ...
            if ($skip == 0) {
                foreach (Session::get("posCart") as $cart) {
                    ...
                    //$cart['tax'] = ($cart['taxExclusiveValue'] > 0) ? $cart['taxExclusiveValue'] : $cart['taxInclusiveValue'];
                    $cart['tax'] = (($cart['taxExclusiveValue'] > 0) ? $cart['taxExclusiveValue'] : $cart['taxInclusiveValue']) * $cart['quantity'];
                    /*$tax = Functions::getTaxAmountByProductId($cart['productId'],"price");
                    $cart['taxHeading'] = $tax['taxHeading'];
                    $cart['taxPercent'] = $tax['taxPercent'];
                    $cart['taxExclusiveValue'] = $tax['taxExclusiveValue'];
                    $cart['taxInclusiveValue'] = $tax['taxInclusiveValue'];
                    $cart['tax'] = $tax['tax'];
                    $cart['basePriceCost'] = $tax['basePriceCost'];*/
